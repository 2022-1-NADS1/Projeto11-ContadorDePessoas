...
const char* ssid = "NET_05135C";
const char* password = "1294781921";
...
void paginahtmlon() {
  ...
  String page = 
  "<html>"
  "<script>function autoRefresh(){window.location = window.location.href;}setInterval('autoRefresh()',4000);</script>"
